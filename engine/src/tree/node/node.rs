...
impl Node {
    ...
    pub fn score(&self) -> f32 {
        let cumulative_score = self.cumulative_score.load(Ordering::Relaxed) as f64 / f64::from(SCORE_SCALE);
    ...
    pub fn add_iteration(&self, score: f32) {
    ...
    pub fn add_children(&self, start_index: usize, chilren_count: usize) {
        self.children_start_index.store(start_index as u32, Ordering::Relaxed);
