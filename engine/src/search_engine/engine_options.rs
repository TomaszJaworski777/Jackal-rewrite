...
create_options! {
    EngineOptions {
        ...
        Tunables {
            ...
            //Time manager
            start_moves_to_go:      f64  =>  25.0,         10.0,  50.0,    2.5,    0.002;
            end_moves_to_go:        f64  =>  16.0,         10.0,  50.0,    1.6,    0.002;
            mtg1:                   f64  =>  24.0,         10.0,  50.0,    2.4,    0.002;
            mtg2:                   f64  =>  20.0,         10.0,  50.0,    2.0,    0.002;
            move_reference:         f64  =>  1000.0,       0.0,   5000.0,  100.0,  0.002;
            curve_scale_power:      f64  =>  -0.07,        -1.0,  1.0,     0.007,  0.002;
