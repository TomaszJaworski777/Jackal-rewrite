...
create_options! {
    EngineOptions {
        ...
        Tunables {
            ...
            //Time manager
            start_moves_to_go:      f64  =>  24.946866,    10.0,  50.0,    2.5,    0.002;
            end_moves_to_go:        f64  =>  15.965994,    10.0,  50.0,    1.6,    0.002;
            mtg1:                   f64  =>  23.722737,    10.0,  50.0,    2.4,    0.002;
            mtg2:                   f64  =>  20.231052,    10.0,  50.0,    2.0,    0.002;
            move_reference:         f64  =>  997.874660,   0.0,   5000.0,  100.0,  0.002;
            curve_scale_power:      f64  =>  -0.069851,    -1.0,  1.0,     0.007,  0.002;
            ...
            bonus_ply_scale:        f64  =>  0.040085,     0.0,   1.0,     0.004,  0.002;
            bonus_ply_offset:       f64  =>  2.004250,     0.0,   5.0,     0.2,    0.002;
