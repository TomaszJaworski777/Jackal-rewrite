...
create_options! {
    EngineOptions {
        ...
        Tunables {
            ...
            //Time manager
            start_moves_to_go:      f64  =>  30.0,         10.0,  50.0,    2.5,    0.002;
            end_moves_to_go:        f64  =>  25.0,         10.0,  50.0,    1.6,    0.002;
            mtg1:                   f64  =>  28.0,         10.0,  50.0,    2.4,    0.002;
            mtg2:                   f64  =>  26.0,         10.0,  50.0,    2.0,    0.002;
