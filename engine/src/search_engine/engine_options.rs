...
create_options! {
    EngineOptions {
        ...
        Tunables {
            ...
            visit_distr_power:          f64  =>  1.24,  1.0,  5.0,   0.13,   0.002;
            visit_distr_scale:          f64  =>  1.65,  0.0,  5.0,   0.2,    0.002;
            visit_reward_clamp:         f64  =>  0.5,   0.0,  1.0,   0.1,    0.002;
            visit_penalty_clamp:        f64  =>  0.5,   0.0,  2.0,   0.1,    0.002;
            visit_gap_threshold:        f64  =>  0.4,   0.0,  1.0,   0.04,   0.002;
            visit_gap_power:            f64  =>  1.16,  1.0,  5.0,   0.12,   0.002;
            visit_gap_scale:            f64  =>  0.8,   0.0,  5.0,   0.1,    0.002;
            visit_gap_reward_clamp:     f64  =>  0.2,   0.0,  1.0,   0.05,   0.002;
            visit_gap_penalty_clamp:    f64  =>  0.2,   0.0,  2.0,   0.05,   0.002;
            falling_eval_ema_alpha:     f64  =>  0.65,  0.0,  1.0,   0.05,   0.002;
            falling_eval_multi:         f64  =>  4.25,  0.0,  10.0,  0.5,    0.002;
            falling_eval_power:         f64  =>  1.72,  1.0,  5.0,   0.2,    0.002;
